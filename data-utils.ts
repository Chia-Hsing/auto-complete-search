...
const toSuggestionList = (repositories: any[]) => {
...
const toSearchResult = (repositories: any[]) => {
...
export const getSearchResult = (keyword: string, sort: string = 'stars', order = 'desc', page = 1, perPage = 10) => {
