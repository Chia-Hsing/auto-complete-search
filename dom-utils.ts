export const fillAutoSuggestions = (suggestions: string[]) => {
    const suggestionElement = document.querySelector('#suggestions') as HTMLDataListElement;
...
export const fillSearchResult = (searchResult: { name: string; stars: number; forks: number }[]) => {
    const repositoriesTableBodyElement = document.querySelector('#repositories tbody') as HTMLTableElement;
...
export const loading = () => {
    const loadingBlockElement = document.querySelector('#loading-block') as HTMLDivElement;
...
const getStarsOrderElement = () => {
    return document.querySelector('#sort-stars-icon') as HTMLSpanElement;
};

const getForksOrderElement = () => {
    return document.querySelector('#sort-forks-icon') as HTMLSpanElement;
};
